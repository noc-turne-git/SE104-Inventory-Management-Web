...
export const MOCK_WAREHOUSES: Warehouse[] = [
  ...
  },
  {
    ...
    lastUpdate: "1d ago",
    status: WarehouseStatus.LOW_STOCK,
    productCount: 8902,
  ...
  {
    warehouseId: "wh-3",
    name: "Tokyo Smart Storage",
    address: "Tokyo, Japan",
    lastUpdate: "45m ago",
    status: WarehouseStatus.SHIFT_VACANCY,
    productCount: 5600,
    imageUrl: "https://picsum.photos/seed/tokyo-wh/800/400",
  },
  {
    warehouseId: "wh-4",
    name: "London Express Depot",
    address: "London, UK",
    lastUpdate: "5h ago",
    status: WarehouseStatus.DEFECTIVE_BATCH,
    productCount: 3200,
    imageUrl: "https://picsum.photos/seed/london-wh/800/400",
  },
];
