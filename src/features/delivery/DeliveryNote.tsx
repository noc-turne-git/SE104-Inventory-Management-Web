  ...
  return (
    <div key={delivery.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          <span className={`px-3 py-1 text-xs font-bold rounded-full capitalize ${getStatusColor(delivery.status)}`}>
            {delivery.status}
          </span>
        </div>
      </div>
      ...
      <div className="mb-4">
        <p className="text-xs font-bold text-gray-400 uppercase mb-3">Package Items:</p>
